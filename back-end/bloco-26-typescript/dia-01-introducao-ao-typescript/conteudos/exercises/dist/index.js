...
console.log(`Losango de diagonal maior 200cm e diagonal menor 50cm: ${Exercise.diamond(200, 50)}cm²`);
...
console.log(`Trapézio de raio 25cm: ${Exercise.circle(25)}cm²`);
console.log(`Trapézio de raio 100cm: ${Exercise.circle(100)}cm²`);
console.log(`Trapézio de raio 12,5cm: ${Exercise.circle(12.5)}cm²`);
